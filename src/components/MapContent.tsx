...
export default function MapContent({ activeStates }: ProjectMapProps) {
    ...
    return (
            <div
                ref={mapRef}
                className="relative w-[620px] h-[800px] bg-[url('/india.svg')] bg-contain bg-no-repeat bg-center"
            >
                {mapSize.width > 0 &&
